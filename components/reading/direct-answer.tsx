...
export function DirectAnswer({ paragraphs, t }: DirectAnswerProps) {
  return (
    <section className="reading-section reading-section--direct-answer reading-surface reading-surface--midnight-navy px-5 py-6 sm:px-7" aria-labelledby="reading-direct-answer">
