...
test("the two historical 0007 migrations are additive and preserve backend/commercial tables", () => {
  ...
  assert.deepEqual(names.slice(-5), ["0006_credits_vip.sql", "0007_backend_completion.sql", "0007_sepay_commercial.sql", "0008_credit_fulfillment_timestamp.sql", "0009_affiliate_referral_links.sql"]);
