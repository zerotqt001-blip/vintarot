...
|---|---|---|
| Research-audit checkout | codex/tooling-and-version-history, HEAD dec2db0ef76f0ad4f5888747fb32f75e1a79478b | Historical authoring snapshot; it was dirty with user-owned UI/state/test work and is not the publication branch. |
| Publication base | codex/natarot-level4-spreadboard-l1c, a53dc44d5c088f2e9685e31f3e4a9dc51a09ebea | Dedicated branch base selected from the latest verified/pushed normalized SpreadBoard source; not merged or deployed. |
