    ...
    <div className="membership-page">
      ...
      {!loading && !messageKey && orderedPackages.length > 0 && <>
        ...
        <div className="membership-support-grid">
          <section className="membership-support-panel membership-vip" aria-labelledby="vip-title"><div className="membership-support-icon"><Crown size={22} strokeWidth={1.2} aria-hidden="true" /></div><div><span className="membership-eyebrow">{t("member.vipEyebrow")}</span><h2 id="vip-title">{t("member.vipTitle")}</h2><p>{t("member.vipText")}</p></div><span className="membership-coming-soon">{t("member.vipComingSoon")}</span></section>
